  ...
  return (
    <div className="flex flex-col items-start gap-2 md:items-end">
      <button
        ...
        disabled={isPending}
        className="inline-flex rounded-md border border-red-200 bg-red-50 px-4 py-2 text-sm font-semibold text-red-700 transition hover:bg-red-100 disabled:opacity-60"
      >
